...
class SiswaSMA(Manusia):
    # Bisa ditambah i Method sendiri ya kawann, tidak harus sama :)
    def __init__(self,nama,kelas,jurusan): # Inputan Juga boleh beda, tidak harus sama
        self.nama = nama
        self.kelas = kelas
